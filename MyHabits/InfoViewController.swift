...
class InfoViewController: UIViewController {
    ...
    private func layout() {
        ...
        scrollView.addSubview(paragraph1)
        scrollView.addSubview(paragraph2)
        scrollView.addSubview(paragraph3)
        scrollView.addSubview(paragraph4)
        scrollView.addSubview(paragraph5)
        scrollView.addSubview(paragraph6)
